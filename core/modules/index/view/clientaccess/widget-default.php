	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">INICIO DE USUARIOS</div>
...
<form class="form-horizontal" role="form" method="post" action="index.php?action=clientaccess">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="email" name="email1" class="form-control" id="inputEmail1" placeholder="Correo Electronico">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-block btn-default">Iniciar Sesión</button>
    </div>
  </div>
</form>
				</div>
